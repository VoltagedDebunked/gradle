...
class EdgeState implements DependencyGraphEdge {
    ...
    private void calculateTargetConfigurations(ComponentState targetComponent) {
        ...
        try {
            ...
            targetVariants = dependencyMetadata.selectVariants(resolveState.getVariantSelector(), attributes, targetComponentState, resolveState.getAttributesSchema(), dependencyState.getDependency().getSelector().getCapabilitySelectors());
