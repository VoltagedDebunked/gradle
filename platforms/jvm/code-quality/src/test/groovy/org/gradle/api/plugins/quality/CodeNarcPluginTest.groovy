...
class CodeNarcPluginTest extends AbstractProjectBuilderSpec {
    ...
    def "adds codenarc extension"() {
        ...
        codenarc.configFile.asFile.get() == project.file("config/codenarc/codenarc.xml")
    ...
    def "configures any additional codenarc tasks"() {
        ...
        task.configFile.asFile.get() == project.file("config/codenarc/codenarc.xml")
    ...
    def "can customize additional tasks via extension"() {
        ...
        task.configFile.asFile.get() == project.file("codenarc-config")
