...
[[upgrading_version_8]]
= Upgrading your build from Gradle 8.x to Gradle 9.0

[[unix_file_permissions_removed]]
==== Unix mode based file permissions removed ====
...
The new API has now been promoted to stable and the old methods have been deprecated in Gradle 8.8.
In Gradle 9.0 these old methods have been completely removed:
