...
class DefaultCachedClasspathTransformerTest extends ConcurrentSpec {
    ...
    def "copying transform copies file into cache"() {
        ...
        def cachedFile = testDir.file("cached/o_92463a53270c346b08579323e3c67d02/thing.jar")
    ...
    def "custom transform transforms file into cache"() {
        ...
        jar(file)
        def classpath = DefaultClassPath.of(file)
        def cachedFile = testDir.file("cached/0188c995231a0f4294427cfdce5fce5b/thing.jar")
    ...
    def "custom transform transforms directory into cache"() {
        ...
        classesDir(dir)
        def classpath = DefaultClassPath.of(dir)
        def cachedFile = testDir.file("cached/7f003722ca28324280a1667f3aa50b93/thing.dir")
    ...
    def "custom transform transforms multiple entries into cache"() {
        ...
        def cachedDir = testDir.file("cached/7f003722ca28324280a1667f3aa50b93/thing.dir")
        def cachedFile = testDir.file("cached/0188c995231a0f4294427cfdce5fce5b/thing.jar")
    ...
    def "applies client provided transform to file"() {
        ...
        jar(file)
        def classpath = DefaultClassPath.of(file)
        def cachedFile = testDir.file("cached/f8f3b56e0bfa755041d47d339ccdbb52/thing.jar")
    ...
    def "transformation keeps the compression level of archive entries"() {
        ...
        def classpath = DefaultClassPath.of(file)
        def cachedFile = testDir.file("cached/cf184f69ee2f5f78606ca816fa15ca73/thing.jar")
